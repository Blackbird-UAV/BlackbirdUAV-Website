...
import { faDraftingCompass, faPlane, faCogs, faUsers, faClipboard } from "@fortawesome/free-solid-svg-icons";
...
const tabs = [
  ...
  },
  {
    ...
    tagline: "The heart of the operation – keeping everything running like clockwork.",
    content: "The Administration team is crucial to the success of Blackbird UAV. You’ll manage schedules, resources, and communication, ensuring that everything stays on track throughout the season. This is a great opportunity for leaders who are organized and passionate about project management. You'll be the glue that keeps the team together and running efficiently, coordinating tasks and ensuring deadlines are met so that every team can do its best work.",
